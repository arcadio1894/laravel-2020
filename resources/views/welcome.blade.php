...
<div class="site-wrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <div class="social-wrap">
                        ...
                        <a href="#"><span class="icon-cart-plus"></span></a>
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
        <div class="intro-section" style="background-image: url({{ asset('landing/images/hero_1.jpg')}});">
            <div class="container">
                <div class="row align-items-center">
    ...
    <div class="section-bg style-1" style="background-image: url({{ asset('landing/images/hero_1.jpg')}});">
        <div class="container">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="post-entry-big">
                                <a href="news-single.html" class="img-link"><img src="{{ asset('landing/images/blog_large_1.jpg')}}" alt="Image" class="img-fluid"></a>
                        ...
                        <div class="col-lg-6">
                            <div class="post-entry-big horizontal d-flex mb-4">
                                <a href="news-single.html" class="img-link mr-4"><img src="{{ asset('landing/images/blog_1.jpg')}}" alt="Image" class="img-fluid"></a>
                                <div class="post-content">
                                    <div class="post-meta">
                                        <a href="#">June 6, 2019</a>
                                        <span class="mx-1">/</span>
                            ...
                            <div class="post-entry-big horizontal d-flex mb-4">
                                <a href="news-single.html" class="img-link mr-4"><img src="{{ asset('landing/images/blog_2.jpg')}}" alt="Image" class="img-fluid"></a>
                                <div class="post-content">
                                    <div class="post-meta">
                                        <a href="#">June 6, 2019</a>
                                        <span class="mx-1">/</span>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url({{ asset('landing/images/bg_1.jpg')}})">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
